            ...
            <div className="container px-4">
              <Card className="max-w-md mx-auto text-center shadow-elegant">
                <CardContent className="p-12">
                  ...
                  <Button onClick={() => navigate("/boutique")} size="lg" className="shadow-elegant">Voir la boutique</Button>
                </CardContent>
              </Card>
            </div>
          </section>
              ...
              <div>
                <Card className="shadow-elegant sticky top-4">
                  <CardContent className="p-6 space-y-4">
                    ...
                    <Button variant="outline" className="w-full" onClick={() => navigate("/boutique")}>Continuer mes achats</Button>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <textarea value={customerAddress} onChange={(e) => setCustomerAddress(e.target.value)} placeholder="Ex: 123 Rue Mohammed V, Quartier Maarif" rows={3} style={{
                width: '100%', padding: '10px', border: '2px solid #e5e7eb', borderRadius: '8px', fontSize: '16px', resize: 'vertical'
              }} />
            </div>

            <div style={{ 
              padding: '15px', backgroundColor: '#f9fafb', borderRadius: '8px', marginBottom: '20px'
            }}>
              ...
              <div style={{ fontSize: '14px', color: '#6b7280' }}>
                ...
                <div style={{ 
                  ...
                  fontWeight: '600', fontSize: '16px', color: '#059669'
                }}>Total: {getTotalPrice()} DH</div>
              </div>
            </div>

            <div style={{ display: 'flex', gap: '10px' }}>
              <button onClick={() => setShowCheckout(false)} disabled={isSubmitting} style={{
                flex: 1, padding: '12px', backgroundColor: '#e5e7eb', border: 'none',
